...
const ECOSYSTEM_PROJECTS: EcosystemProject[] = [
  {
    ...
    tooltip:
      "React-based TUI framework for building terminal applications. Reconciler, components, and theme system.",
  ...
  },
  {
    ...
    tooltip:
      "High-performance flexbox layout engine. Yoga-compatible with zero allocations and composable plugins.",
  ...
  },
  {
    ...
    tooltip:
      "Structured logging with namespace filtering, spans, and zero-overhead conditional logging.",
  ...
  },
  {
    ...
    tooltip:
      "Comprehensive terminal feature database. 148 features across 10+ terminals with probe-based testing.",
