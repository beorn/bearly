...
| `@bearly/bear`  | _private (0.3.0)_                                  | Workspace daemon MCP server — recall memory + focus cache + future coordination. Phases 1–3 of the bear plan (bead `km-bear`). | `plugins/bear/`  |
